...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItem(Long userId, ItemAddDto itemAddDto) {
        return post("", userId, itemAddDto);
    }
    ...
    public ResponseEntity<Object> addComment(Long userId, Long itemId, CommentAddDto commentAddDto) {
