...
public class BookingControllerTest {
    ...
    public void getBookerBookings_shouldReturnBookings() throws Exception {
        when(service.getBookerBookings(anyLong(), any(BookingStateDto.class), anyInt(), anyInt()))
    ...
    public void getOwnerBookings_shouldReturnBookings() throws Exception {
        when(service.getOwnerBookings(anyLong(), any(BookingStateDto.class), anyInt(), anyInt()))
                .thenReturn(List.of(booking));
